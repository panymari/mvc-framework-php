...
//var_dump($cart->getServiceInfo(new InstallService("22.05.2022", "test3", 23231)));
//var_dump($cart->getServiceInfo(new SupportService("23.05.2022", "test4", 1173672)));


//add several products
//var_dump($cart->addProduct(new FridgeProduct("fridge", "test2", "13.07.2020", 121212)));
//var_dump("<br><br>");
//var_dump($cart->addProduct(new TvSetProduct("TV set", "test1", "12.07.2020", 10000)));

//without error on service, but with advise in product
//var_dump($cart->addProduct(new TvSetProduct("TV set", "test1", "12.07.2020", 10000)));
//var_dump($cart->addProduct(new FridgeProduct("Fridge", "test1", "12.07.2020", 10000)));
//var_dump($cart->addService(new SupportService("23.05.2022", "test4", 1173672)));

//okay adding test and product
//$cart->addProduct(new TvSetProduct("TV set", "test1", "12.07.2020", 10000));
//var_dump($cart->addService(new SupportService("23.05.2022", "test4", 1173672)));
...
//add to cart
//var_dump($cart->calculateTotalSum());